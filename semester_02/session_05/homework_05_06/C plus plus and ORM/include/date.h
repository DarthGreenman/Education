...
namespace tpsg
{
	...
	{
	public:
		const static auto jan() { return month{ 1u }; }
		const static auto feb() { return month{ 2u }; }
		const static auto mar() { return month{ 3u }; }
		const static auto apr() { return month{ 4u }; }
		const static auto may() { return month{ 5u }; }
		const static auto jun() { return month{ 6u }; }
		const static auto jul() { return month{ 7u }; }
		const static auto aug() { return month{ 8u }; }
		const static auto sep() { return month{ 9u }; }
		const static auto oct() { return month{ 10u }; }
		const static auto nov() { return month{ 11u }; }
		const static auto dec() { return month{ 12u }; }
		...
		const static auto get_month(unsigned m)
		{
	...
	template<typename T,
		...
		struct from_string
	{
		const static auto get(const std::string& y)
		{
	...
	{
		const static auto get(const std::string& m)
		{
