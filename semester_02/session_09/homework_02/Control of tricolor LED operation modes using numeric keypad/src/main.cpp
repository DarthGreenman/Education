...
keypad small {
    fox::make_pair(5, uno::membrane_keypad::C1),
    fox::make_pair(4, uno::membrane_keypad::C2),
    fox::make_pair(3, uno::membrane_keypad::C3),
    fox::make_pair(2, uno::membrane_keypad::C4),
    fox::make_pair(12, uno::membrane_keypad::R1),
    fox::make_pair(8, uno::membrane_keypad::R2),
    fox::make_pair(7, uno::membrane_keypad::R3),
    fox::make_pair(6, uno::membrane_keypad::R4)
};
...
void setup()
{
    ...
    small.assign_names(
        ascii::one, ascii::two, ascii::three, ascii::A,
        ascii::four, ascii::five, ascii::six, ascii::B,
        ascii::seven, ascii::eight, ascii::nine, ascii::C,
        ascii::asterisk, ascii::zero, ascii::number, ascii::D);
...
void loop()
{
    ...
    if (static_cast<bool>(timeout)
        && millis() - uptime >= static_cast<uint16_t>(timeout)) {
        uptime = millis();
        led.blink(color);
    }
}