...
public:
    using pointer_to_callback_function =
        typename uno::table_of_callback_functions<uno::key_events>::pointer_to_callback_function;
    ...
    explicit keypad(Binds&&... binds) { fox::expand_parameter_package { (construct(binds.first, binds.second), 1)... }; }
...
private:
    ...
    fox::pair<elem_row[K::number_of_rows], elem_col[K::number_of_columns]>
        _channels { };
