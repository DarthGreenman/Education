...
namespace wokwi
{
	template <wokwi::signal_direction Sd = wokwi::signal_direction::input_pullup>
	class button : public wokwi::electronic_component<wokwi::signal_digital, Sd>
	{
		static_assert(Sd != wokwi::signal_direction::output, "Invalid signal direction parameter value.");
	...
	public:
		...
		using basic = wokwi::electronic_component<wokwi::signal_digital, Sd>;

		constexpr button() = default;
		explicit button(uint8_t pin_number)
			: wokwi::electronic_component<wokwi::signal_digital, Sd>(pin_number) {}
	...
	template <wokwi::signal_direction Sd>
	void wokwi::button<Sd>::update()
	{
		...
		Sd == wokwi::signal_direction::input_pullup ? call(wokwi::signal_digital::low, wokwi::signal_digital::high)
