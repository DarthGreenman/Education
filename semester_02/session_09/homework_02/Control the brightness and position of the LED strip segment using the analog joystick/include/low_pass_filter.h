...
#ifndef LOW_PASS_FILTER_H_FOR_THE_ARDUINO_UNO_PROJECT
#define LOW_PASS_FILTER_H_FOR_THE_ARDUINO_UNO_PROJECT
...
#endif // !LOW_PASS_FILTER_H_FOR_THE_ARDUINO_UNO_PROJECT